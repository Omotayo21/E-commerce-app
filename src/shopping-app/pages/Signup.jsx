            ...
            <div className="p-6 space-y-4 sm:p-8">
              ...
              >
                ...
                <div>
                  ...
                  <button
                    className="text-white bg-blue-600 hover:bg-primary-700 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 pr-5 cursor:pointer"
