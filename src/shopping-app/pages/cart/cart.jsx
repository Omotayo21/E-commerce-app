...
<div> 
  ...
  <div className=" inline-block ml-4"><button
    onClick={() => navigate("/shop")}
    className="bg-blue-700  text-white border rounded-lg border-white h-10 sm:w-36 lg:w-48 lg:font-bold hover:border-blue-900">
      Continue shopping
  </button>
 <button 
 className="bg-green-700 text-white ml-8 border rounded-lg border-white h-10 lg:w-48 sm:w-40 lg:font-bold hover:border-green-900">
